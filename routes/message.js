...
messageRouter.get('/all', jwtUtils.tokenPresence, messageCtrl.getAllMessages);
messageRouter.get('/:id/specific', messageCtrl.getOneMessage);
messageRouter.get('/profilMessages', jwtUtils.tokenValidation, messageCtrl.getProfileStatAndMessages);
